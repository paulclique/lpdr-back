...
export interface ApiEstablishmentEstablishment
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    childEstablishments: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    money_boxes: Schema.Attribute.Relation<
      'oneToMany',
      'api::money-box.money-box'
    >;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
...
export interface ApiMoneyBoxMoneyBox extends Struct.CollectionTypeSchema {
  collectionName: 'money_boxes';
  info: {
    displayName: 'MoneyBox';
    pluralName: 'money-boxes';
    singularName: 'money-box';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    establishment: Schema.Attribute.Relation<
      'manyToOne',
      'api::establishment.establishment'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiSessionSession extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    money_box: Schema.Attribute.Relation<
      'oneToOne',
      'api::money-box.money-box'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::money-box.money-box': ApiMoneyBoxMoneyBox;
